...
description: Use to review system design architecture outputs. Validates trade-off
  analysis, estimation accuracy, pattern applicability, SPOF detection, and scalability
  claims. Pairs with system-designer.
...
Load: `.github/skills/nw-sd-framework/SKILL.md` -- read it NOW before proceeding.
Load: `.github/skills/nw-sd-patterns/SKILL.md` -- read it NOW before proceeding.
