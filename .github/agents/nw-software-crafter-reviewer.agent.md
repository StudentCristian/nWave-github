...
description: Use for review and critique tasks - Code quality and implementation review
...
- `.github/skills/nw-sc-review-dimensions/SKILL.md`
- `.github/skills/nw-tdd-review-enforcement/SKILL.md`
