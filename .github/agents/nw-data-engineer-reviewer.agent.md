...
| Phase | Load | Trigger |
|-------|------|---------|
| Apply Review Dimensions | `.github/skills/nw-der-review-criteria/SKILL.md` | Before Phase 2 |
...
2. **Apply Review Dimensions** — Load `.github/skills/nw-der-review-criteria/SKILL.md` NOW before proceeding. Evaluate against each dimension. Record findings with severity (blocker|major|minor|suggestion). Gate: all applicable dimensions evaluated.
