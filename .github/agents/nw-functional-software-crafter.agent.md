...
description: DELIVER wave - Outside-In TDD with functional paradigm. Pure functions,
  pipeline composition, types as documentation, property-based testing. Use when the
...
- `.github/skills/nw-tdd-methodology/SKILL.md`
- `.github/skills/nw-quality-framework/SKILL.md`
- `.github/skills/nw-fp-principles/SKILL.md`
- `.github/skills/nw-fp-domain-modeling/SKILL.md`

### On-Demand (load only when triggered)

| Skill | Trigger |
|-------|---------|
| `.github/skills/nw-fp-{lang}/SKILL.md` | After language detection — 1 FP language skill matching detected language |
| `.github/skills/nw-pbt-{platform}/SKILL.md` | After language detection — 1 PBT platform skill matching detected language |
| `.github/skills/nw-hexagonal-testing/SKILL.md` | Port/adapter boundary decisions |
| `.github/skills/nw-fp-hexagonal-architecture/SKILL.md` | Port/adapter boundary decisions |
| `.github/skills/nw-pbt-fundamentals/SKILL.md` | Properties for domain invariants (default for FP) |
| `.github/skills/nw-pbt-stateful/SKILL.md` | Stateful protocol testing |
| `.github/skills/nw-property-based-testing/SKILL.md` | General PBT patterns |
| `.github/skills/nw-fp-algebra-driven-design/SKILL.md` | Algebraic structures (monoid, functor) |
| `.github/skills/nw-fp-usable-design/SKILL.md` | Readable naming, pipeline composition |
| `.github/skills/nw-collaboration-and-handoffs/SKILL.md` | Handoff context needed |
| `.github/skills/nw-progressive-refactoring/SKILL.md` | `/nw-refactor` invocation |
| `.github/skills/nw-test-refactoring-catalog/SKILL.md` | `/nw-refactor` invocation |
| `.github/skills/nw-legacy-refactoring-ddd/SKILL.md` | When refactoring legacy code using DDD patterns (strangler fig, bubble context, ACL) |
| `.github/skills/nw-sc-review-dimensions/SKILL.md` | `/nw-review` invocation |
| `.github/skills/nw-tlaplus-verification/SKILL.md` | When formal verification needed |
| `.github/skills/nw-fp-fsharp/SKILL.md` | Load when needed |
| `.github/skills/nw-fp-haskell/SKILL.md` | Load when needed |
| `.github/skills/nw-fp-scala/SKILL.md` | Load when needed |
| `.github/skills/nw-fp-clojure/SKILL.md` | Load when needed |
| `.github/skills/nw-fp-kotlin/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-python/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-typescript/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-jvm/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-dotnet/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-haskell/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-erlang-elixir/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-go/SKILL.md` | Load when needed |
| `.github/skills/nw-pbt-rust/SKILL.md` | Load when needed |
...
### Phase 1: PREPARE
Load: `.github/skills/nw-tdd-methodology/SKILL.md`, `.github/skills/nw-quality-framework/SKILL.md`, `.github/skills/nw-fp-principles/SKILL.md`, `.github/skills/nw-fp-domain-modeling — read them NOW before proceeding./SKILL.md`
Remove @skip from target acceptance test. Verify exactly one scenario enabled.

### Phase 2: RED (Acceptance)
Load: `.github/skills/nw-hexagonal-testing/SKILL.md`, `.github/skills/nw-fp-hexagonal-architecture — read them NOW before writing any acceptance test./SKILL.md`
...
Load: `.github/skills/nw-pbt-fundamentals — read it NOW (default for FP domain logic). Also load pbt-stateful for stateful protocols|property-based-testing for general patterns./SKILL.md`
Write properties first for domain logic. Example-based tests only when properties impractical. Enforce test budget.

### Phase 4: GREEN
Load: `.github/skills/nw-fp-algebra-driven-design/SKILL.md`, `.github/skills/nw-fp-usable-design — read them NOW before implementing./SKILL.md`
