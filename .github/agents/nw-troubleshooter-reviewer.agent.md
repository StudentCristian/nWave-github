...
description: Use for review and critique tasks - Risk analysis and failure mode review
...
- `.github/skills/nw-tr-review-criteria/SKILL.md`

## Workflow

At the start of execution, create these tasks using #tool:todo and follow them in order:

1. **Intake** — Load `.github/skills/nw-tr-review-criteria/SKILL.md`. Read the RCA document. Identify all causal branches and WHY levels. Gate: document loaded, skill loaded, branch structure understood.
