---
name: nw-diverger
description: Use before DISCUSS — runs JTBD analysis, competitive research, structured
  brainstorming, and taste-filtered evaluation to produce 3-5 design directions before
  the team converges on one. Use when the team has a validated problem but hasn't
  chosen a solution approach.
tools:
- read/readFile
- edit/createFile
- edit/editFiles
...
|-------|-------|---------------|
| 1 — JTBD Analysis | `nw-jtbd-analysis` | Read `.github/skills/nw-jtbd-analysis/SKILL.md` |
| 2 — Competitive Research | `nw-researcher` (agent) | Use the nw-researcher agent as a subagent |
| 3 — Brainstorming | `nw-brainstorming` | Read `.github/skills/nw-brainstorming/SKILL.md` |
| 4 — Taste Evaluation | `nw-taste-evaluation` | Read `.github/skills/nw-taste-evaluation/SKILL.md` |
