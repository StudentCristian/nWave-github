...
description: Use as hard gate before DESIGN wave - validates journey coherence, emotional
  arc quality, shared artifact tracking, Definition of Ready checklist, LeanUX antipatterns,
...
- `.github/skills/nw-por-review-criteria/SKILL.md`

### Phase 2: 3 DoR and Antipattern Review

Read these files NOW:
- `.github/skills/nw-dor-validation/SKILL.md`
